...
export default function AdminSendInvites({ recipientCount }: Props) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 space-y-4">
      <p className="text-sm text-zinc-400">
        Skicka magic links via Resend till alla{' '}
        <strong className="text-zinc-200">{recipientCount} unika e-poster</strong> i pending_assignments.
        Varje person får en personlig inloggningslänk. Profil och uppgiftstilldelningar skapas automatiskt vid inloggning.
      </p>
      ...
      >
        {loading ? 'Skickar...' : `Skicka magic links (${recipientCount} st)`}
      </button>
    </div>
  )
}
