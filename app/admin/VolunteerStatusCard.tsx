...
interface Vol { name: string | null; email: string }
              ...
              <ul className="divide-y divide-zinc-800/60">
                {loggedIn.map(v => (
                  <li key={v.email} className="px-4 py-2 flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-green-500/15 border border-green-800 flex items-center justify-center text-[10px] text-green-400 font-bold shrink-0">
