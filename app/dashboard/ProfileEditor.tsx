...
export default function ProfileEditor({ profileId, initialName, initialPhone }: Props) {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    await supabase.from('profiles').update({ name: name.trim(), phone: phone.trim() }).eq('id', profileId)
    setSaving(false)
    setSaved(true)
  }
